...
from tests import inverter_stub


def make_inverter(**overrides):
    """Shared stub inverter, plus the timestamp register pvoutput requires."""
    overrides.setdefault('latest_scrape', {
        'total_active_power': 5000,
        'daily_power_yields': 10.5,
        'timestamp': '2024-01-15 12:00:00',
    })
    return inverter_stub.make_inverter(**overrides)
