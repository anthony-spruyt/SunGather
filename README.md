...
For SG\* Models this is calculated from meter*power if -ve value, returned as a positive value. (\_For Hybrid models export_power_hybrid is used*)  
...
<img src="img/HomeAssistant-SunGrow_Device.png" alt="Home Assistant SunGrow Device"/>
...
SG25CX-SA, SG75CX, SG3.0RT, SG4.0RT, SG5.0RT, SG6.0RT, SG7.0RT, SG8.0RT, SH8.ORT-V112,
SG10RT. SH10RT-V112, SG12RT, SG15RT, SG17RT, SG20RT
